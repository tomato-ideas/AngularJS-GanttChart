    ...
    return {
        ...
        controller: ['$scope', '$element', function ($scope, $element) {
            ...
            $scope.raiseRowClickedEvent = function(evt, row, column, date) {
                $scope.onRowClicked({ event: { evt: evt, row: row, column: column.clone(), date: date, userTriggered: true, rows: $scope.gantt.rows } });
            };
            ...
            $scope.raiseRowDblClickedEvent = function(evt, row, column, date) {
                $scope.onRowDblClicked({ event: { evt: evt, row: row, column: column.clone(), date: date, userTriggered: true, rows: $scope.gantt.rows } });
            };
            ...
            $scope.raiseTaskUpdatedEvent = function(task, userTriggered) {
               // console.log( $scope.gantt.rows);
                $scope.onTaskUpdated({ event: { task: task, userTriggered: userTriggered, rows: $scope.gantt.rows } });
            };
